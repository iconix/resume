...
\newcommand\projects{
    ...
    {\begin{itemize}  \itemsep -18pt %reduce space between items
      \item \href{https://github.com/iconix/openai}{OpenAI Scholar work on GitHub} \\
      \item \href{https://github.com/iconix/fast.ai}{fast.ai coursework \& notes on GitHub} \\
...
\begin{twenty} % Environment for a list with descriptions
    \twentyitem
        ...
        \item Follow my progress! \href{https://iconix.github.io/tags/openai}{https://iconix.github.io/tags/openai}
        \end{itemize}}
        }
    \\
    \twentyitem
