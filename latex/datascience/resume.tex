...
\programming{{Rails $\textbullet$ Java $\textbullet$ C++ $\textbullet$ C $\textbullet$ \large \LaTeX / 3}, {C\# $\textbullet$ Bash $\textbullet$ R $\textbullet$ NoSQL / 4}, {HTML5 $\textbullet$ TypeScript $\textbullet$ JS $\textbullet$ SQL / 5}, {Python $\textbullet$ PyTorch / 6}}
...
\newcommand\projects{
    ...
    {\begin{itemize}  \itemsep -18pt %reduce space between items
      ...
      \item \item \href{https://youtu.be/-6Aq5Q0c-CU}{OpenAI Scholars Demo Day} - 2018 \\
