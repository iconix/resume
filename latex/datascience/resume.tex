...
\newcommand\projects{
    ...
    {\begin{itemize}  \itemsep -18pt %reduce space between items
      \item {[GitHub]} \href{https://github.com/iconix/deephypebot}{@deephypebot: a music commentary generator using deep learning} \\
      \item {[GitHub]} \href{https://github.com/iconix/openai}{OpenAI Scholar work} \\
