...
\newcommand\projects{
    ...
    {\begin{itemize}  \itemsep -18pt %reduce space between items
      ...
      \item Topic models \& dimensionality reduction \\
      \item \textit{pkmn.mars} React + DeepNLP web app \\
      \item Kaggle: \textit{State Farm Distracted Driver Detection} \& \textit{Dogs vs. Cats} (post-contest) \\
      \item fast.ai coursework \\
      \item A Python translation of an R analysis of \textit{Love Actually} \\
      \item \textit{Women in Data Science Conference} - Feb 3, 2017 (online) \\
      \item \textit{Grace Hopper Celebration of Women in Computing} - Oct 19-21, 2016 \\
      \item \textit{Y Combinator's Female Founders Conference} - Mar 1, 2014
    \end{itemize}}
}
