...
\programming{{C $\textbullet$ C++ $\textbullet$ \large \LaTeX / 3}, {R $\textbullet$ Shell $\textbullet$ Java / 3.5}, {C\# $\textbullet$ Python $\textbullet$ Rails / 5}, {HTML5 $\textbullet$ TypeScript $\textbullet$ JS / 5.5}}
