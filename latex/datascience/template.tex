...
\newcommand\projects{
    ...
    {\begin{itemize}  \itemsep -18pt %reduce space between items
      ...
      \item Kaggle: \textit{State Farm Distracted Driver Detection} and \textit{Dogs vs. Cats} (post-competition) \\
      \item fast.ai coursework \\
      \item An Python translation of an R analysis of \textit{Love Actually} \\
